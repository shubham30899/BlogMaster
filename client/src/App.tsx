          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center space-x-2 mb-4">
                ...
                <h3 className="text-xl font-bold text-white">BlogCraft</h3>
              </div>
              <p className="text-slate-400">Modern blogging platform with dynamic content blocks for developers and creators.</p>
            </div>
            <div>
              <h4 className="font-semibold text-white mb-4">Platform</h4>
              <ul className="space-y-2">
                <li><a href="/create" className="hover:text-primary transition-colors">Create Post</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="hover:text-primary transition-colors">Block Guide</a></li>
